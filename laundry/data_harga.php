...
<head>
    ...
    <title>Data Harga - Laundry Express</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div>
                            <a href="#" class="btn btn-primary m-1">Add Service</a>
                            <a href="#" class="btn btn-primary m-1">Edit Service</a>
                        </div>
                        <div class="d-flex justify-content-around mt-4 mb-4">
                            <div class="box p-4">Laundry Kiloan</div>
                            <div class="box p-4">Dry Cleaning</div>
                            <div class="box p-4">Laundry On Demand</div>
                        </div>
                    </div>
                    <div class="card mb-4">
