...
<head>
    ...
    <title>Transaksi - Laundry Express</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Laundry Express</a>
        <!-- Sidebar Toggle-->
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>01/01/2023</td>
                                        <td>Rp.50.000</td>
                                        <td><a href="#" class="btn btn-primary">Lunas</a></td>
                                    </tr>
                                    <tr>
                                        <td>1</td>
                                        <td>002</td>
                                        ...
                                        <td>01/01/2023</td>
                                        <td>Rp.50.000</td>
                                        <td><a href="#" class="btn btn-secondary">Confirm</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
